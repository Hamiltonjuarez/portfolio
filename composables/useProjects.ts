...
const projects: Project[] = [
  {
    ...
    screenshots: [
      { src: "01-home.png", alt: "Buddy Assist landing page" },
    ],
    accent: "#e46767",
  },
  {
    ...
    screenshots: [
      { src: "01-home.png", alt: "Surf resort home page" },
      { src: "02-about.png", alt: "About / story section" },
      { src: "03-dining.png", alt: "Dining section" },
      { src: "04-services.png", alt: "Surf services and programs" },
      { src: "05-stay.png", alt: "Accommodations listing" },
    ],
    accent: "#e49567",
  },
  {
    ...
    screenshots: [
      { src: "01-home.png", alt: "Solid home page" },
      { src: "02-work.png", alt: "Work / portfolio listing" },
      { src: "03-services.png", alt: "Services page" },
      { src: "04-about.png", alt: "About page" },
      { src: "05-blog.png", alt: "Blog index" },
    ],
    accent: "#e4c567",
  },
  {
    ...
    screenshots: [
      { src: "01-home.png", alt: "Intranet portal sign-in / dashboard" },
    ],
    accent: "#d4e467",
  },
  {
    ...
    screenshots: [
      { src: "01-home.png", alt: "Restaurant home page" },
      { src: "02-about.png", alt: "About section" },
      { src: "03-menu.png", alt: "Menu page" },
      { src: "04-gallery.png", alt: "Photo gallery" },
      { src: "05-contact.png", alt: "Contact page" },
    ],
    accent: "#a6e467",
  },
  {
    ...
    screenshots: [
      { src: "01-home.png", alt: "Agency home page" },
      { src: "02-work.png", alt: "Work showcase" },
      { src: "03-blog.png", alt: "Blog index" },
      { src: "04-contact.png", alt: "Contact page" },
      { src: "05-clients.png", alt: "Client showcase" },
    ],
    accent: "#78e467",
  },
  {
    ...
    screenshots: [
      { src: "01-home.png", alt: "Cobra Studio home page" },
      { src: "02-about.png", alt: "About page" },
      { src: "03-solutions.png", alt: "Solutions / services" },
      { src: "04-blog.png", alt: "Blog index" },
      { src: "05-projects.png", alt: "Projects showcase" },
    ],
    accent: "#67e487",
  },
  {
    ...
    screenshots: [
      { src: "01-home.png", alt: "Car rental home with fleet" },
      { src: "02-conditions.png", alt: "Rental conditions page" },
      { src: "03-privacy.png", alt: "Privacy page" },
    ],
    accent: "#67e4b6",
  },
  {
    ...
    screenshots: [
      { src: "01-home.png", alt: "Observatory experiences home" },
      { src: "02-experiences.png", alt: "Experiences listing" },
      { src: "03-blog.png", alt: "Blog index" },
      { src: "04-about.png", alt: "About page" },
      { src: "05-gallery.png", alt: "Photo gallery" },
    ],
    accent: "#67e4e4",
  },
  {
    ...
    screenshots: [
      ...
      { src: "02-about.png", alt: "About page" },
      { src: "03-menu.png", alt: "Menu page" },
      { src: "04-experience.png", alt: "Experience page" },
      { src: "05-faq.png", alt: "FAQ page" },
    ],
    accent: "#67b6e4",
  },
  {
    ...
    screenshots: [
      { src: "01-home.png", alt: "Surf travel home page" },
      { src: "02-about.png", alt: "About page" },
      { src: "03-contact.png", alt: "Contact page" },
    ],
    accent: "#6787e4",
  },
  {
    ...
    screenshots: [
      { src: "01-home.png", alt: "Consulting firm home page" },
      { src: "02-services.png", alt: "Services page" },
      { src: "03-work.png", alt: "Work / portfolio" },
      { src: "04-blog.png", alt: "Blog index" },
      { src: "05-about.png", alt: "About page" },
    ],
    accent: "#7867e4",
  },
  {
    ...
    screenshots: [
      { src: "01-home.png", alt: "Nonprofit home page" },
      { src: "02-about.png", alt: "About page" },
      { src: "03-services.png", alt: "Programs and services" },
      { src: "04-blog.png", alt: "Blog index" },
      { src: "05-contact.png", alt: "Contact page" },
    ],
    accent: "#a667e4",
  },
  {
    ...
    screenshots: [
      { src: "01-home.png", alt: "Travel platform home page" },
      { src: "02-about.png", alt: "About page" },
      { src: "03-gallery.png", alt: "Photo gallery" },
      { src: "04-blog.png", alt: "Blog index" },
    ],
    accent: "#d467e4",
  },
  {
    ...
    screenshots: [
      { src: "01-home.png", alt: "Restaurant and hotel home page" },
      { src: "02-menu.png", alt: "Interactive menu" },
      { src: "03-hotel.png", alt: "Surf hotel showcase" },
    ],
    accent: "#e467c5",
  },
  {
    ...
    screenshots: [
      { src: "01-home.png", alt: "Digital menu platform" },
    ],
    accent: "#e46795",
  },
];
